...
-- Ẩn tóc từ clothing pack addon khi tạo nhân vật mới (salon/barber vẫn dùng được).
Config.HidePackHairOnCharacterCreation = {
    enabled = true,
    collections = {
        'zzz_clothpackv9',
    },
...
-- Blip chỉ hiện khi gần (không ghim minimap toàn map). Display 2 = minimap + bản đồ lớn.
Config.Blips = {
    ["clothing"] = {
        Show = true,
        Sprite = 366,
...
Config.Stores = {
    ...
    },
    {
        ...
        hgrpShopKey = 'clothing_normal',
        blipName = 'Cửa hàng quần áo',
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    },
    {
        ...
        hgrpShopKey = 'clothing_premium',
        blipName = 'Boutique cao cấp',
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
...
Config.Outfits = {
    ["police"] = {
        -- CANH BAO: ID qb-clothing pack KHONG khop clothpackv1-v8 tren server HGRP.
        -- Preset "bo do san" co the sai — dung shop illenium tai phong trang phuc (mien phi).
        -- Sau khi mac dung: /dumpoutfit de lay ID that, roi paste vao outfitData ben duoi.
        ["Male"] = {
            {
                name = "PCSO",
                outfitData = {
            ...
            },
            {
                ...
                outfitData = {
                    ...
                    ["torso2"] = {item = 442, texture = 2},
                    ["shoes"] = {item = 12, texture = 2},
                    ["vest"] = {item = 0, texture = 0},
                    ["bag"] = {item = 5, texture = 0},
                    ["hat"] = {item = -1, texture = -1},
                    ["glass"] = {item = -1, texture = 0},
                    ["mask"] = {item = 0, texture = 0},
                },
    ...
    ["ambulance"] = {
        -- ID tu qb-clothing pack (clothpack addon)
        ["Male"] = {
            {
                name = "Thuc tap sinh",
                outfitData = {
            ...
            },
            {
                name = "Nhan vien y te",
                outfitData = {
                    ["pants"] = {item = 208, texture = 4},
                    ["arms"] = {item = 4, texture = 0},
                    ["torso2"] = {item = 321, texture = 0},
                    ["shoes"] = {item = 3, texture = 0},
                    ["accessory"] = {item = 126, texture = 0},
                    ["bag"] = {item = 158, texture = 10},
                    ["hat"] = {item = -1, texture = 0},
                    ["glass"] = {item = -1, texture = 0},
                    ["mask"] = {item = -1, texture = 0},
                },
            ...
            },
            {
                ...
                outfitData = {
                    ...
                    ["arms"] = {item = 4, texture = 0},
                    ["t-shirt"] = {item = 38, texture = 0},
                    ["torso2"] = {item = 348, texture = 9},
            ...
            },
            {
                ...
                outfitData = {
                    ["arms"] = {item = 4, texture = 0},
                    ["torso2"] = {item = 349, texture = 0},
                    ["shoes"] = {item = 6, texture = 0},
                    ["accessory"] = {item = 183, texture = 0},
                    ["bag"] = {item = 155, texture = 10},
                    ["hat"] = {item = -1, texture = 0},
                    ["glass"] = {item = -1, texture = 0},
                    ["mask"] = {item = -1, texture = 0},
                },
            ...
            },
            {
                ...
                outfitData = {
                    ...
                    ["t-shirt"] = {item = 26, texture = 0},
                    ["torso2"] = {item = 28, texture = 0},
                    ["shoes"] = {item = 6, texture = 0},
                    ["accessory"] = {item = 126, texture = 0},
                    ["bag"] = {item = 129, texture = 10},
                    ["hat"] = {item = -1, texture = 0},
                    ["glass"] = {item = -1, texture = 0},
                    ["mask"] = {item = -1, texture = 0},
                },
        ...
        ["Female"] = {
            ...
            },
            {
                ...
                outfitData = {
                    ...
                    ["torso2"] = {item = 579, texture = 0},
                    ["shoes"] = {item = 3, texture = 0},
                    ["accessory"] = {item = 317, texture = 0},
                    ["bag"] = {item = 161, texture = 10},
                    ["hat"] = {item = -1, texture = 0},
                    ["glass"] = {item = -1, texture = 0},
                    ["mask"] = {item = -1, texture = 0},
                },
...
Config.InitialPlayerClothes = {
    Male = {
        ...
        Components = {
            ...
            {
                component_id = 3, -- Upper Body (tay / thân trên)
                drawable = 15,
                texture = 0
            },
            {
                component_id = 4, -- Lower Body (quần / chân)
                drawable = 14,
                texture = 0
            },
            {
